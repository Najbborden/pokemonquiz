...
const Questions = [{
  id: 0,
  q: "What is the best starter pokemon",
  a: [{ text: "Quaxly", isCorrect: false },
    { text: "Snivy", isCorrect: false },
    { text: "Froakie", isCorrect: true },
...
{
  id: 1,
  q: "How many Gym Badges do you need tto challenge the elite 4?",
...
{
  id: 2,
  q: "Best Elite 4 Member?",
  a: [{ text: "Agatha", isCorrect: false },
    { text: "Drake", isCorrect: true },
    { text: "Lance", isCorrect: false },
